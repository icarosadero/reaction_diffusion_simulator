...
begin
plot(
heatmap(result[1,:,:], color=:greys, title="S1"),
heatmap(result[2,:,:], color=:greys, title="S2"),
heatmap(result[3,:,:], color=:greys, title="I"),
heatmap(result[4,:,:], color=:greys, title="S"),
)
end